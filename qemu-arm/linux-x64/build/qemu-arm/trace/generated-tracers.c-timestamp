...
TraceEvent *__build_qemu_arm_trace_events[] = {
...
static void trace___build_qemu_arm_register_events(void)
{
    trace_event_register_group(__build_qemu_arm_trace_events);
}
trace_init(trace___build_qemu_arm_register_events)
